...
class StatusCodeTest(TestCase):
    ...
    def test_404_status(self):
        """
        Должен вернуть код 404, 
        потому что в загруженных фикстурах нет пользователя с id=5
        """
    ...
    def test_200_status(self):
        ...
        потому что в загруженных фикстурах есть пользователь с id=2
        """
...
class DigestTest(TransactionTestCase):
    ...
    def test_first_digest(self):
        ...
        Второй запрос для того же пользователя должен вернуть дайджест,
        в котором три поста.
        """
        response = self.client.get("/api/digest/", {"userid": 2, "rating": 8})
